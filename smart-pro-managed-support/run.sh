...
VERSION="${SMART_PRO_MANAGED_VERSION:-3.17.1}"
PORT="8098"
...
echo "Checkpoint 3.17.1: bounded foreground first-device MeshAgent canary μόνο μετά από Broker admin arm. Ανενεργά: MeshAgent -install, service/systemd persistence, technician web/Terminal/Files/Desktop authorization. Raw execution tickets/.msh/binary δεν αποθηκεύονται."
echo "===================================================="
