...
VERSION="${SMART_PRO_MANAGED_VERSION:-3.17.6}"
PORT="8098"
...
echo "Checkpoint 3.17.6: first-device target-binding compatibility με reuse-only stable identity. Το unattended lifecycle παραμένει ενεργό μόνο με verified exact identity. Ανενεργά: MeshAgent -install, service/systemd persistence, technician web/Terminal/Files/Desktop authorization."
echo "===================================================="
