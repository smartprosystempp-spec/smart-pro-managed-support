...
Η 3.18.2 υποστηρίζει **amd64** και **aarch64**. Το Broker και το add-on δένουν κάθε λήψη MeshAgent με την πραγματική αρχιτεκτονική του Managed node και επαληθεύουν header, SHA-256, byte count και ELF `e_machine` πριν από οποιαδήποτε foreground εκτέλεση.

Η προσθήκη aarch64 δεν ενεργοποιεί τα ιστορικά first-device QA εργαλεία σε ARM. Εκείνα παραμένουν κλειδωμένα στο αρχικό τους scope.
...
Στη stable 3.18.2 οι ιστορικές mutation/test ενέργειες είναι κλειδωμένες. Η κατάσταση και η τεκμηρίωσή τους παραμένουν διαθέσιμες για forensic troubleshooting.
...
Η τελική customer-facing ενεργοποίηση δεν αποτελεί μέρος της 3.18.2. Η παλιά τεχνική pairing φόρμα παραμένει κλειδωμένη ως ιστορική αναφορά. Η μελλοντική ροή θα σχεδιαστεί ξεχωριστά γύρω από το Customer Portal και one-time activation.
